              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildGlassCard(
                    child: ListTile(
                      leading:
                          Icon(Icons.person, color: FuturisticTheme.neonCyan),
                      title: Text('Profile',
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    chatProvider.updateSettings(
                                      ...
                                      cloudProvider:
                                          chatProvider.currentCloudProvider,
                                      cloudModel:
                                          chatProvider.currentCloudModel,
                                    );
                                  },
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 12),
                                    decoration: BoxDecoration(
                                      color: chatProvider.currentMode ==
                                              AIMode.desktopClient
                      ...
                      child: Column(
                        children: [
                          DropdownButtonFormField<String>(
                            dropdownColor:
                                FuturisticTheme.getSurfaceColor(isDark),
                            ...
                            items: [
                              ...
                              "Custom"
                                ...
                                .map((e) => DropdownMenuItem(
                                    value: e,
                                    child: Text(e,
                                        style: FuturisticTheme.getBodyStyle(
                                            isDark))))
                                .toList(),
                            onChanged: (val) {
                              if (val != null) {
                          ...
                          const SizedBox(height: 10),
                          if (chatProvider.currentCloudProvider ==
                              "Custom") ...[
                            TextField(
                                ...
                                Expanded(
                                    child: ElevatedButton.icon(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                            backgroundColor: FuturisticTheme
                                                .neonCyan
                                                .withAlpha(50),
                                            foregroundColor:
                                                FuturisticTheme.neonCyan),
                                        onPressed: _showSaveApiDialog)),
                                ...
                                Expanded(
                                    child: ElevatedButton.icon(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                            ...
                                            foregroundColor:
                                                FuturisticTheme.neonPurple),
                                        onPressed: _showLoadApiBottomSheet)),
                              ],
                            ),
                            const SizedBox(height: 10),
                          ],
                      ...
                      child: Column(
                        children: [
                          Icon(Icons.desktop_windows,
                              size: 50, color: FuturisticTheme.neonCyan),
                          const SizedBox(height: 10),
                          Text("Connect to PocketMind Desktop Bridge",
                  ...
                  // 6. Bio Lock
                  SwitchListTile(
                    title: Text("Bio-Lock Security",
                        style: FuturisticTheme.getBodyStyle(isDark)),
                    subtitle: Text("Require fingerprint on startup",
                        style: TextStyle(
                            color: FuturisticTheme.textGray, fontSize: 12)),
                  ...
                  ListTile(
                    ...
                    title: Text("AI Personas",
                        style: FuturisticTheme.getBodyStyle(isDark)),
                    subtitle: Text("Manage custom system personalities.",
                        style: TextStyle(color: FuturisticTheme.textGray)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  ListTile(
                    ...
                    title: Text("Knowledge Base",
                        style: FuturisticTheme.getBodyStyle(isDark)),
                    subtitle: Text("Manage PDF documents and memory.",
                        style: TextStyle(color: FuturisticTheme.textGray)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
